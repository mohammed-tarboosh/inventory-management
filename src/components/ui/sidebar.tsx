      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[calc(100vw-1rem)] max-w-[18rem] bg-sidebar p-2 text-sidebar-foreground [&>button]:hidden"
            style={
              {
          ...
          >
            ...
            <div className="flex h-full w-full flex-col rounded-md bg-sidebar px-1 py-2">{children}</div>
          </SheetContent>
        </Sheet>
      );
    }
