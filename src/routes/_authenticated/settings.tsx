...
function CurrencyForm({
  ...
  return (
    <Dialog
      ...
      onOpenChange={(v) => {
        setOpen(v);
        if (!v && editing && onCancelEdit) onCancelEdit();
      }}
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{editing ? t("edit") : t("currencies")}</DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={submit} disabled={!code || !ar}>
            {t("save")}
          </Button>
        </DialogFooter>
      </DialogContent>
...
function RateForm({
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{editing ? t("edit") : t("exchange_rates")}</DialogTitle>
        </DialogHeader>
        <div className="space-y-3">
          <div>
          ...
          <div>
            <Label>{t("rate_date")}</Label>
            <DatePicker value={rate_date} onValueChange={setDate} />
          </div>
        </div>
        <DialogFooter>
          <Button
